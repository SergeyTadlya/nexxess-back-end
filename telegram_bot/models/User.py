...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    photo = models.ImageField(verbose_name='Profile avatar', default='profile-user.png', upload_to='')
    ...
    phone = models.CharField(verbose_name='Phone', max_length=24, null=True, blank=True)
    bio = models.TextField(verbose_name='Bio', max_length=2048, null=True, blank=True)
    country = models.CharField(verbose_name='Country', max_length=64, null=True, blank=True)
    city = models.CharField(verbose_name='City/State', max_length=64, null=True, blank=True)
    street = models.CharField(verbose_name='Street', max_length=128, null=True, blank=True)
    tax_id = models.CharField(verbose_name='TAX ID', max_length=64, null=True, blank=True)
    telegram_id = models.PositiveIntegerField(verbose_name='Telegram user ID', null=True, blank=True)
    telegram_username = models.CharField(verbose_name='Telegram username', max_length=64, null=True, blank=True)
