        ...
        $.ajax({
            ...
            success: (data) => {
                ...
                for (invoice in data['invoices'][0]){
                    if (data['invoices'][0][invoice].more_one) {
                        html_invoice += `
                            <div class="content__body">
                              <p class="content__body-titleDate">` + data['invoices'][0][invoice].date + `</p>`
                        }
                    html_invoice += `
                        <ul class="content__body-list">
                            ...
                            <ul class="content__body-items" id="list">
                                <li  class="content__body-item style--width">
                                    ...
                                    <a class="content__body-link" href="detail/` + data['invoices'][0][invoice].id + `/">
                                ...
                                if (data['invoices'][0][invoice].status_value != 'Paid'){
                                    html_invoice += `
                                    <li class="content__body-item style--width">
